...
const propsWithDefinitions: any = {
...
describe('FormBuilder', () => {
  ...
  it('renders the appropriate number of cards', () => {
   ...
   "properties": {
    ...
    const div = document.createElement('div');
    document.body.appendChild(div);
    const wrapper = mount(<FormBuilder {...modProps} />, {
      attachTo: div
    });
  ...
  it('generates warning messages', () => {
   ...
   "invalidUiProp": "asdf"
    ...
    const errors = wrapper.find('.alert-warning').first().find('li').map(error => error.text());
      ...
      uischema: `
{
   ...
   "invalidUiProp": "asdf"
    ...
    const blocks = wrapper.find('.collapse').map(block => block.find('.card-text').first().props().value);
  ...
  it('renders custom labels in the form head', () => {
    const div = document.createElement('div');
    document.body.appendChild(div);
    const wrapper = mount(<FormBuilder {...props} mods={{
      labels: {
  ...
  it("should allow changing of Section's Display Name", () => {
    ...
    const div = document.createElement('div');
    document.body.appendChild(div);
    const wrapper = mount(<FormBuilder {...innerProps} />, {
      attachTo: div
    });
    const sectionHeadInputs = wrapper.find('.section-container').first().find('.section-head').first().find('input');
