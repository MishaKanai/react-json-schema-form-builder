...
describe('CardGallery', () => {
  it('renders without error', () => {
    ...
    const wrapper = mount(<CardGallery {...props} />, {
      attachTo: div
    });
  ...
  it('renders appropriate number of cards with a give definition', () => {
    ...
    const div = document.createElement('div');
    document.body.appendChild(div);
    const wrapper = mount(<CardGallery {...modProps} />, {
      attachTo: div
    });
  ...
  it('calls the onChange method when editing a card', () => {
    ...
    const titleField1 = wrapper.find('.form_gallery_container').first().find('.card-text').at(2);
