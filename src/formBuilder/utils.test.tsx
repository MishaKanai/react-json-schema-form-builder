...
import {
  ...
  generateElementComponentsFromSchemas as _generateElementComponentsFromSchemas,
  generateElementPropsFromSchemas as _generateElementPropsFromSchemas,
  generateSchemaFromElementProps as _generateSchemaFromElementProps,
  generateUiSchemaFromElementProps as _generateUiSchemaFromElementProps,
  getCardCategory as _getCardCategory,
  getNewElementDefaultDataOptions as _getNewElementDefaultDataOptions,
  getRandomId,
  parse as _parse,
...
const parse: any = _parse;
const getCardCategory: any = _getCardCategory;
const stringify: any = _stringify;
const generateElementPropsFromSchemas: any = _generateElementPropsFromSchemas;
const generateElementComponentsFromSchemas: any = _generateElementComponentsFromSchemas;
const generateSchemaFromElementProps: any = _generateSchemaFromElementProps;
const generateUiSchemaFromElementProps: any = _generateUiSchemaFromElementProps;
const getNewElementDefaultDataOptions: any = _getNewElementDefaultDataOptions;

function generateSchemaWithUnnamedProperties(amount) {
  const properties = [...Array.from(Array(10).keys())].reduce((acc, id) => {
    return { ...acc,
      [`${DEFAULT_INPUT_NAME}${id + 1}`]: {
        type: 'string'
      }
    };
  }, {});
...
describe('generateSchemaFromElementProps', () => {
  const schemaProps = generateSchemaFromElementProps(elementPropArr, DEFAULT_FORM_INPUTS);
  ...
  it('throws an exception if propType is invalid', () => {
    expect(() => generateSchemaFromElementProps([{
      name: 'card3',
      required: true,
      dataOptions: {
        type: 'boolean'
...
describe('generateUiSchemaFromElementProps', () => {
  const uiSchema = generateUiSchemaFromElementProps(elementPropArr, DEFAULT_FORM_INPUTS);
...
describe('generateElementComponentsFromSchemas', () => {
  it('propagates mods to Section component', () => {
    const MockComponent: any = jest.fn(() => <div />);
    const mods = {
      customFormInputs: {
        test: {
          displayName: 'Test',
    ...
    const allFormInputs: any = { ...DEFAULT_FORM_INPUTS,
