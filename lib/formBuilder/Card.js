    ...
    return React.createElement(React.Fragment, null,
        React.createElement(Collapse_1.default, { isOpen: cardOpen, toggleCollapse: function () { return setCardOpen(!cardOpen); }, title: React.createElement(React.Fragment, null,
                React.createElement("span", null,
                    React.createElement(Tooltip_1.default, { disableInteractive: true, placement: 'top', title: "Move form element up" },
                        React.createElement("span", null,
                    ...
                    React.createElement(Tooltip_1.default, { disableInteractive: true, placement: 'top', title: "Move form element down" },
                        React.createElement("span", null,
                            React.createElement(IconButton_1.default, { size: "small", onClick: function (e) {
                                    e.stopPropagation();
                                    e.preventDefault();
            ...
            React.createElement("div", { style: cardInteractionsStyle },
                React.createElement(Tooltip_1.default, { disableInteractive: true, placement: "top", title: "Additional configurations for this form element" },
                ...
                React.createElement(Tooltip_1.default, { disableInteractive: true, placement: 'top', title: "Delete form element" },
