...
function DependencyField(_a) {
    ...
    return react_1.default.createElement(Box_1.default, { className: 'form-dependency', sx: dependencyFieldSx },
        ...
        react_1.default.createElement("div", { className: 'form-dependency-conditions' },
            ...
            react_1.default.createElement(Tooltip_2.default, { disableInteractive: true, placement: "top", title: "Add another dependency relation linking this element and other form elements" },
