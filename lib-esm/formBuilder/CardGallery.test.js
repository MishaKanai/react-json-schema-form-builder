...
import { generateCategoryHash } from "./utils.js";
...
describe('CardGallery', function () {
    it('renders without error', function () {
        ...
        var wrapper = mount(React.createElement(CardGallery, __assign({}, props)), {
            attachTo: div
        });
    ...
    it('renders appropriate number of cards with a give definition', function () {
        ...
        var div = document.createElement('div');
        document.body.appendChild(div);
        var wrapper = mount(React.createElement(CardGallery, __assign({}, modProps)), {
            attachTo: div
        });
