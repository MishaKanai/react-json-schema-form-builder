...
describe('FormBuilder', function () {
    it('renders without error', function () {
        ...
        var wrapper = mount(React.createElement(FormBuilder, __assign({}, props)), {
            attachTo: div
        });
    ...
    it('renders the appropriate number of cards', function () {
        ...
        var div = document.createElement('div');
        document.body.appendChild(div);
        var wrapper = mount(React.createElement(FormBuilder, __assign({}, modProps)), {
            attachTo: div
        });
    ...
    it('renders custom labels in the form head', function () {
        var div = document.createElement('div');
        document.body.appendChild(div);
        var wrapper = mount(React.createElement(FormBuilder, __assign({}, props, { mods: {
                labels: {
    ...
    it('renders $refs with custom titles and descriptions', function () {
        var div = document.createElement('div');
        document.body.appendChild(div);
        var wrapper = mount(React.createElement(FormBuilder, __assign({}, propsWithDefinitions)), {
            attachTo: div
        });
        expect(wrapper.exists('.form-body')).toBeTruthy();
    ...
    it("should allow changing of Section's Display Name", function () {
        ...
        var div = document.createElement('div');
        document.body.appendChild(div);
        var wrapper = mount(React.createElement(FormBuilder, __assign({}, innerProps)), {
            attachTo: div
        });
